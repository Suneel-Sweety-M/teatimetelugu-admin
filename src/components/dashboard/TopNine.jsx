...
import { addTopNinePosts, getTopNinePosts } from "../../helper/apis";
...
const TopNine = () => {
  ...
  const handleSave = async () => {
    if (selected.length !== maxLimit) {
      toast.info(`Select exactly ${maxLimit} posts.`);
      return;
    }
  ...
  return (
    <>
      <div className="das-news-container">
        ...
        ></i>
        <div className="das-news-container-title">Top Nine Posts</div>
